...
def remove_comments_and_commented_lines(file_path):
    ...
    # Remove any remaining empty lines (more than 2 consecutive)
...
def main():
    ...
    try:
        cleaned_content = remove_comments_and_commented_lines(file_path)
